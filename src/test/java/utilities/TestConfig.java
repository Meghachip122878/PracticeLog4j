...
public class TestConfig{
	...
	public static String from = "meghachip@gmail.com";
	public static String password = "Selenium@123";
	public static String[] to ={"meghamala1228@gmail.com"};
	public static String subject = "Extent Project Report";
	
	public static String messageBody ="TestMessage";
	public static String attachmentPath="C:\\Users\\malama\\Desktop\\Error.jpg";
